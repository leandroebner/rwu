...
if(sample == 0 && memory == 1 && millis() - ref1 >= debounce){ 
  counter = counter +10;                                                                  //triggers on falling edge of push button input signal while confirming cooldown    //toggles the virtual output
  ref1 = millis();}        
