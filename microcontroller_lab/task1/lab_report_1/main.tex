...
\section{Hardware design and development}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{graphicx/hardware}
        \caption{Simplified schematic with common ground from the arduino and nets corresponding to the two utulized pins.}
        \label{hardware}
    \end{figure}  
...
\begin{figure}[h]
    ...
    \caption{Flowchart of the final code. \\ The \emph{heartbeat} is excluded for simplicity reasons. \cite{flow}}
    \label{flowchart}
\end{figure}
