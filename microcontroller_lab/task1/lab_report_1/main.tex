...
\subsection{Functions}
    ...
    The heart beat timer is based on the the \texttt{millis()} function too. This \texttt{if} conditions fulfils the simple function of a timer and toggles the onboard LED of the Arduino on pin 13 in a very similar way, then the button-toggling mechanism.
