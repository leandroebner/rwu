...
\section{Hardware design and development}
    ...
    \begin{figure}[h]
        ...
        \caption{Simplified schematic with common ground from the arduino and nets corresponding to the two utulized pins. \cite{schem}}
        \label{schem}
    \end{figure}    
